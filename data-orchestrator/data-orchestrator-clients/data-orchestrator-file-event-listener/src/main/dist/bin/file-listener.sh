...
do
    case ${var} in
        ...
        ;;
        -h)
            echo "Usage: file-listener.sh"

            echo "command options:"
            echo "  -xdebug             Start File Listener under JPDA debugger"
...
java ${JAVA_OPTS} -classpath "${AIRAVATA_CLASSPATH}" \
    org.apache.airavata.dataorchestrator.file.client.FileClientInitializer ${AIRAVATA_COMMAND} $*
